...
case "$1" in
  ...
  add|tidy|discover|refs) sleep 0.8; type_cmd "${CMD[$1]}"; ${CMD[$1]} 2>/dev/null; sleep 4 ;;
  *) echo "usage: $0 record [add|tidy|discover|refs] | add | tidy | discover | refs"; exit 2 ;;
esac
