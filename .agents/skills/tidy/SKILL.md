...
2. Handle the output exactly like `download`: **PAUSE** rows -> the printed `python3 zc.py tidy --only <key> ...` line
   ...
   satisfy); candidates -> report them; obviously wrong tags -> `python3 zc.py untag`.
